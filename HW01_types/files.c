...
---- Для начала цикла есть:
        ...
        e. Цикл должен записывать имя переменной как в функции get_filename_from_zip, но только в массив или структуру? Понятно, что и то и другое должно быть динамическим...
        f. Надо будет читать и выводить по элементу массива (или структуры?) в main, пока она не закончится...
*/
